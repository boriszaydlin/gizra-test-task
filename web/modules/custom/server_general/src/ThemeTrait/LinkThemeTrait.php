...
trait LinkThemeTrait {
   ...
   *   Render array.
   */
  public function buildLinkWithIcon(array|string|TranslatableMarkup $content, Url $url, ColorEnum $color = ColorEnum::DarkGray, UnderlineEnum $underline = UnderlineEnum::Hover, IconsEnum $icon = IconsEnum::Default): array
  {
    $element = [
      '#theme' => 'server_theme_link_icon',
      '#url' => $url,
      '#title' => $content,
      '#icon' => $icon->value,
    ];
